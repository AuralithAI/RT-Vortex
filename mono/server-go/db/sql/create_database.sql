...
-- Connect to the new database and grant ownership / default privileges.
\connect rtvortex

-- Make rtvortex the owner of the public schema so it can CREATE/ALTER/DROP
-- any object — even if tables were accidentally created by postgres.
ALTER SCHEMA public OWNER TO rtvortex;

-- Default privileges: any future objects created by postgres are also accessible.
